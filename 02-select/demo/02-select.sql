...
-- TOP WITH TIES
-- -------------------------------
-- если после TOP N строк далее есть такое же значение
-- в колонках, указанных в ORDER BY, то эти строки так же возвращаются 
-- используется только с ORDER BY
